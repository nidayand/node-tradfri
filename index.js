...
var transformRawIndentityData = require("./lib/data-transformers")
  .transformRawIndentityData;

var transformRawDeviceData = require("./lib/data-transformers")
  .transformRawDeviceData;

var transformRawGroupData = require("./lib/data-transformers")
...
class Tradfri {
  ...
  generateIdentity(username) {
    ...
    var promise = new RSVP.Promise((resolve, reject) => {
      self.coapClient
        .generateIdentitiy(username)
        .then(r => {
          try {
            resolve(transformRawIndentityData(r, username));
          } catch (err) {
